...
export const STATIONS: { key: StageKey; index: number; name: string; dom: string; hint: string }[] = [
  ...
  { key: "videos", index: 6, name: "視頻", dom: "station-videos", hint: "由每鏡靜態圖生成動態視頻（i2v），做出成片嘅動態片段。" },
  { key: "voice", index: 7, name: "配音", dom: "station-voice", hint: "逐句對白／旁白配音，可以換配音演員或者重配某一句。" },
