  ...
  return (
    <div className="stat-row">
      <div className="stat-card">
        <div className="stat-label">實際成本（USD）</div>
        <div className="stat-value">{usd(totals.actualCostUsd)}</div>
        <div className="stat-sub">
          估算 {usd(totals.estCostUsd)}
          {totals.uncostedCalls > 0 && <> · {int(totals.uncostedCalls)} 次未計價</>}
        </div>
      </div>
      <div className="stat-card">
